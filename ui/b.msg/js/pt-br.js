...
Blockly.Msg["CONTROLS_IF_MSG_ELSE"] = "senão faça";
Blockly.Msg["CONTROLS_IF_MSG_ELSEIF"] = "senão se";
Blockly.Msg["CONTROLS_IF_MSG_IF"] = "❓ Se acontecer";
...
Blockly.Msg["CONTROLS_REPEAT_INPUT_DO"] = "então faça";
...
Blockly.Msg["LISTS_ISEMPTY_TITLE"] = "Verificar se a coleção %1 está vazia";
Blockly.Msg["LISTS_ISEMPTY_TOOLTIP"] = "Retorna verdadeiro se a coleção estiver vazia.";
Blockly.Msg["LISTS_LENGTH_HELPURL"] = "https://github.com/google/blockly/wiki/Lists#length-of";
Blockly.Msg["LISTS_LENGTH_TITLE"] = "Tamanho da lista de %1";
...
Blockly.Msg["LOGIC_BOOLEAN_TRUE"] = "✔️ verdadeiro";
...
Blockly.Msg["LOGIC_NEGATE_TITLE"] = "O contrário de %1";
...
Blockly.Msg["LOGIC_OPERATION_AND"] = "E também";
...
Blockly.Msg["LOGIC_TERNARY_CONDITION"] = "❓ Se";
Blockly.Msg["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
Blockly.Msg["LOGIC_TERNARY_IF_FALSE"] = "senão faça";
Blockly.Msg["LOGIC_TERNARY_IF_TRUE"] = "então faça";
...
Blockly.Msg["MATH_ADDITION_SYMBOL"] = "Adição (+)";
...
Blockly.Msg["MATH_CONSTRAIN_TITLE"] = "Manter o número %1 entre o mínimo de %2 e o máximo de %3";
Blockly.Msg["MATH_CONSTRAIN_TOOLTIP"] = "Se o número for menor que o mínimo, ele se tornará o mínimo. Se for maior que o máximo, ele se tornará o máximo. Se estiver no meio, ele fica igual.";
Blockly.Msg["MATH_DIVISION_SYMBOL"] = "Divisão (÷)";
...
Blockly.Msg["MATH_MULTIPLICATION_SYMBOL"] = "Multiplicação (×)";
...
Blockly.Msg["MATH_POWER_SYMBOL"] = "Potência (^)";
Blockly.Msg["MATH_RANDOM_FLOAT_HELPURL"] = "https://pt.wikipedia.org/wiki/Gerador_de_n%C3%BAmeros_pseudoaleat%C3%B3rios";
Blockly.Msg["MATH_RANDOM_FLOAT_TITLE_RANDOM"] = "Sortear um número decimal entre %1 e %2";
Blockly.Msg["MATH_RANDOM_FLOAT_TOOLTIP"] = "Sorteia um número 'quebrado', como 0.25 ou 0.8. É como sortear uma chance de algo acontecer!";
Blockly.Msg["MATH_RANDOM_INT_HELPURL"] = "https://pt.wikipedia.org/wiki/Gerador_de_n%C3%BAmeros_pseudoaleat%C3%B3rios";
Blockly.Msg["MATH_RANDOM_INT_TITLE"] = "Sortear um número entre %1 e %2";
Blockly.Msg["MATH_RANDOM_INT_TOOLTIP"] = "Escolhe um número ao acaso, como se estivesse a rolar um dado! O número sorteado estará entre o primeiro e o segundo número que você escolher.";
Blockly.Msg["MATH_ROUND_HELPURL"] = "https://pt.wikipedia.org/wiki/Arredondamento";
Blockly.Msg["MATH_ROUND_OPERATOR_ROUND"] = "Arredondar número";
Blockly.Msg["MATH_ROUND_OPERATOR_ROUNDDOWN"] = "Arredondar número para baixo";
Blockly.Msg["MATH_ROUND_OPERATOR_ROUNDUP"] = "Arredondar número para cima";
...
Blockly.Msg["MATH_SINGLE_OP_ABSOLUTE"] = "Número absoluto (sempre positivo)";
...
Blockly.Msg["MATH_SUBTRACTION_SYMBOL"] = "Subtração (-)";
Blockly.Msg["MATH_TRIG_ACOS"] = "Arco cosseno (acos)";
Blockly.Msg["MATH_TRIG_ASIN"] = "Arco seno (asin)";
Blockly.Msg["MATH_TRIG_ATAN"] = "Arco tangente (atan)";
Blockly.Msg["MATH_TRIG_COS"] = "Cosseno (cos)";
Blockly.Msg["MATH_TRIG_HELPURL"] = "https://pt.wikipedia.org/wiki/Fun%C3%A7%C3%A3o_trigonom%C3%A9trica";
Blockly.Msg["MATH_TRIG_SIN"] = "Seno (sin)";
Blockly.Msg["MATH_TRIG_TAN"] = "Tangente (tan)";
...
Blockly.Msg["PROCEDURES_DEFNORETURN_PROCEDURE"] = "Nova ação";
Blockly.Msg["PROCEDURES_DEFNORETURN_TITLE"] = "Criar função chamada";
Blockly.Msg["PROCEDURES_DEFNORETURN_TOOLTIP"] = "Função é como uma receita que você pode usar várias vezes. Esta não devolve nada.";
...
Blockly.Msg["PROCEDURES_DEFRETURN_TOOLTIP"] = "Função é como uma receita que você pode usar várias vezes. Esta devolve um resultado.";
...
Blockly.Msg["PROCEDURES_IFRETURN_TOOLTIP"] = "Se isso for verdade então devolve um resultado.";
...
Blockly.Msg["TEXT_APPEND_TITLE"] = "Adicionar o texto %2 ao final de %1";
Blockly.Msg["TEXT_APPEND_TOOLTIP"] = "Acrescentar um pedaço de texto à variável \"%1\".";
Blockly.Msg["TEXT_CHANGECASE_HELPURL"] = "https://github.com/google/blockly/wiki/Text#adjusting-text-case";
Blockly.Msg["TEXT_CHANGECASE_OPERATOR_LOWERCASE"] = "Minúsculas";
Blockly.Msg["TEXT_CHANGECASE_OPERATOR_TITLECASE"] = "para Nomes Próprios";
Blockly.Msg["TEXT_CHANGECASE_OPERATOR_UPPERCASE"] = "MAIÚSCULAS";
Blockly.Msg["TEXT_CHANGECASE_TOOLTIP"] = "Transforma o texto em maiúsculas ou minúsculas.";
Blockly.Msg["TEXT_CHARAT_FIRST"] = "Primeira letra";
Blockly.Msg["TEXT_CHARAT_FROM_END"] = "obter letra # a partir do final";
Blockly.Msg["TEXT_CHARAT_FROM_START"] = "Letra nº";
Blockly.Msg["TEXT_CHARAT_HELPURL"] = "https://github.com/google/blockly/wiki/Text#extracting-text";  // untranslated
Blockly.Msg["TEXT_CHARAT_LAST"] = "Última letra";
Blockly.Msg["TEXT_CHARAT_RANDOM"] = "Letra aleatória";
Blockly.Msg["TEXT_CHARAT_TAIL"] = "";  // untranslated
Blockly.Msg["TEXT_CHARAT_TITLE"] = "No texto %1 pegar a %2";
...
Blockly.Msg["TEXT_GET_SUBSTRING_END_FROM_START"] = "Letra nº";
Blockly.Msg["TEXT_GET_SUBSTRING_END_LAST"] = "Última letra";
Blockly.Msg["TEXT_GET_SUBSTRING_HELPURL"] = "https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";
Blockly.Msg["TEXT_GET_SUBSTRING_INPUT_IN_TEXT"] = "No texto";
Blockly.Msg["TEXT_GET_SUBSTRING_START_FIRST"] = "Primeira letra";
Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_END"] = "obter trecho de letra nº a partir do final";
Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_START"] = "Letra nº";
...
Blockly.Msg["TEXT_ISEMPTY_TITLE"] = "Verificar se o texto %1 está vazio";
Blockly.Msg["TEXT_ISEMPTY_TOOLTIP"] = "Retorna verdadeiro se o texto fornecido for vazio.";
Blockly.Msg["TEXT_JOIN_HELPURL"] = "https://github.com/google/blockly/wiki/Text#text-creation";  // untranslated
Blockly.Msg["TEXT_JOIN_TITLE_CREATEWITH"] = "Juntar textos";
Blockly.Msg["TEXT_JOIN_TOOLTIP"] = "Criar um pedaço de texto juntando qualquer número de itens.";
Blockly.Msg["TEXT_LENGTH_HELPURL"] = "https://github.com/google/blockly/wiki/Text#text-modification";  // untranslated
Blockly.Msg["TEXT_LENGTH_TITLE"] = "Contar as letras em %1";
Blockly.Msg["TEXT_LENGTH_TOOLTIP"] = "Retorna o número de letras (incluindo espaços) no texto fornecido.";
Blockly.Msg["TEXT_PRINT_HELPURL"] = "https://github.com/google/blockly/wiki/Text#printing-text";
Blockly.Msg["TEXT_PRINT_TITLE"] = "Mostrar no console %1";
Blockly.Msg["TEXT_PRINT_TOOLTIP"] = "Mostra qualquer texto, número ou valor de variável na aba 'Console'. É ótimo para ver o que o seu programa está a fazer!";
